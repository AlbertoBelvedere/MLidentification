...
# test dataset
test = pd.read_hdf(
    'models/2020Nov28ULALL/bdt_final_train/'
    '/bdt_final_train_testdata.hdf', key='data')
...
train = pd.read_hdf(
    'models/2020Nov28ULALL/bdt_final_train/'
    '/bdt_final_train_traindata.hdf', key='data')
...
base = get_model(
    'models/2020Nov28ULALL/bdt_final_train/'
    '/2020Nov28ULALL__final_train_BDT.pkl')
based_features, _ = get_features('final_train')
...
plt.xlim(1e-4, 1)
plt.savefig('ROC_overtraining_final_12.png')
#plt.clf()
